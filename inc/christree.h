 ...
 * @dif: The dif character the node must have
 *
 * Returns: A pointer to the node if one was found or NULL if no node was found
 *          or an error occurred
 */
 ...
 *
 * @prev: Pointer to the previous node in the branch
 ...
 *
 * @tree: Pointer to the tree struct
 * @node: Pointer to the node to unlink from the layer
 */
